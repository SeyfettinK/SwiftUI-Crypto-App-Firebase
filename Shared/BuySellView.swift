...
//  MyCyrpto
//
//  Created by Seyfettin Kılınç on 28.04.2022.
//
            ...
            VStack(spacing: 10){
                ...
                HStack{
                    Button {
                        ...
                        SecondScreen(coiName: appModel.chosenCoin?.name ?? " ", appModel: appModel, viewModel: viewModel)
                    })
                        ...
                        VStack(alignment: .leading, spacing: 6){
                            ...
                            HStack{
                                Text("Kullanılabilir: ")
                                    ...
                                    .padding(.leading,10)
                                Spacer()
                                Text("\(viewModel.oneWalletPieces , specifier: "%.3f")\(" ")\(appModel.chosenCoin?.symbol.uppercased() ?? " ")")
                            }
                        }
                        Button {
