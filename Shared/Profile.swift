            ...
            VStack{
                /*VStack{
                    HStack{
                        ...
                        VStack{
                            HStack{
                                ForEach(viewModel.myUser){ user in
                                    HStack{
                                        Text(user.name)
                                            .font(.system(size: 20))
                                            .fontWeight(.bold)
                ...
                /*Picker("Select text", selection: $selectButton){
                ...
                /* if selectButton == "Cüzdanım" {
                    if let coins = appModel.walletCoin {
                        ScrollView{
                            VStack{
                                KullaniciBilgileriDeneme(coins: coins, favCoin: appModel.walletCoinNameArray)
                            }
                        }
                ...
                /* if selectButton == "Kullanıcı Bilgierim" {
                    UserInformation()
                } */
                Spacer()
